function K = Generate6NodeElementGlobalStiffnessMatrix(K, k, i, j, m, p, q, r)

% This function generates the global stiffness matrix [K] for a system of
% six node elements, based on the element stiffness matrix [k], and the
% indexes of each element node, i, j, m, p, q, r. Note that this function is
